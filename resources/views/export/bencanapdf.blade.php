...
<body>
		...
		<table align="center">
		<tr> 
					<th><img src="{{ asset('images') }}/bpbd.jpg" width="80%">
					</th>
					<td><center><font size="4"><b>
						PEMERINTAH DAERAH KABUPATEN TABALONG</b><br/>
						<b>Badan Penanggulangan Bencana Daerah Kabupaten Tabalong</b></font><br/>
					...
					<th> <img src="{{ asset('images') }}/tabalong.png" width="80%">
					</th></center>  
		<tr>
		...
		<table align="center">
			...
			<tr>
				<td colspan="4">	Dengan ini Disampaikan Bahwa pada hari ini senin, 15 April 1998 telah kami Laporkan Data Kejadian<br> Bencana Alam yang terjadi di Kabupaten Tabalong, sebagai berikut : </td> 
			</tr>
			<br>
		</table> 
		<center><h3><font size="4">Laporan Kejadian Bencana</font></h3></center>
		<table class="table table-striped table-bordered table-hover" id="tabel-data">
			...
			<tbody>
				...
				<tr><span style="font-size:10pt; ">
					...
					<td>{{$b->jenis_bencana}}</td>
					<td>{{$b->lokasi_bencana}}</td>
					<td>{{$b->created_at->format('d M Y')}}</td>
					<td>
						@If(is_null($b)) 
						@else 
						@endif
						@foreach($b->posko as $pos)
						<div> {{ $pos->nama_posko }}, </div>
						@endforeach
					</td></span> 
				</tr>
				@endforeach 
